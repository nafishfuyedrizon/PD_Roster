...
function Toggle({ active, onChange, disabled }: { active: boolean; onChange: (v: boolean) => void; disabled?: boolean }) {
  return (
    <button
      ...
      disabled={disabled}
      title={disabled ? "High Command or above required" : undefined}
                  ...
                  >
                    ...
                    <td className="text-center px-3 py-3">
                      <div className="flex justify-center">
                        <Toggle
                          active={!!s.isSeniorStaff}
                          disabled={!isHighCommand}
                          onChange={(v) => updateMutation.mutate({ id: s.id, field: "isSeniorStaff", value: v })}
                        />
                      </div>
                    </td>
                    <td className="text-center px-3 py-3">
                    ...
                    <td className="text-center px-3 py-3">
                      {isCanEdit ? (
                        ...
                        <Trash2 className="w-3.5 h-3.5 text-muted-foreground/20" />
                      )}
                    </td>
                  </tr>
                ))
